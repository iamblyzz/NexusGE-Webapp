// ─────────────────────────────────────────────────────────────────────────────
// Nexus Global Enterprise — i18n Translation Engine
...
const en: Translations = {
  ...
  hero: {
    ...
    headline: "Your AI-Built App Is Failing in Production. We Architect the Fix.",
    subheadline:
      ...
      items: [
        {
          ...
          detail:
            "Client submitted a Lovable-generated app — zero deployment config, no database, broken authentication routes throughout.",
        },
        {
          phase: "Hour 4",
          label: "Scope Confirmed",
          detail:
            "Full migration scope delivered and approved: Next.js 14 rewrite, Supabase schema provisioning, Vercel deployment pipeline.",
        },
        {
          phase: "Hour 24",
          label: "Migration Underway",
          detail:
            "Codebase migrated to Next.js App Router. Supabase database live with RLS policies enforced. GitHub repository initialized with webhooks.",
        },
        {
          phase: "Hour 68",
          label: "Live in Production",
          detail:
            "Application deployed to Vercel with custom domain, all environment variables mapped, and full smoke test suite passing.",
        },
      ],
    },
  },
  ...
  form: {
    ...
    problem: {
      ...
      placeholder:
        "Describe the issue in detail. What were you trying to do? What error messages are you seeing?",
    ...
    success: {
      ...
      message:
        "Got it. We'll review your submission and reach out within a few hours to confirm scope and next steps.",
...
const es: Translations = {
  ...
  howItWorks: {
    ...
    subheadline:
      "Tres pasos estructurados desde el prototipo de IA hasta la infraestructura de producción.",
    steps: [
      {
        number: "01",
  ...
  services: {
    ...
    subheadline:
      "El alcance exacto se confirma por escrito antes de solicitar cualquier pago.",
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          "Implementación de guardas de límite de tasa de API para prevenir picos de facturación",
  ...
  caseStudy: {
    ...
    subheadline:
      "De prototipo de IA no desplegado a stack de producción verificado en menos de 72 horas.",
    ...
    stackTable: {
      ...
      rows: [
        ...
        ["Autenticación", "Sesión simulada rota", "Autenticación JWT de Supabase"],
      ...
      items: [
        {
          ...
          detail:
            "El cliente envió una aplicación generada por Lovable — sin configuración de despliegue, sin base de datos, rutas de autenticación rotas.",
        },
        {
          phase: "Hora 4",
          label: "Alcance Confirmado",
          detail:
            "Alcance de migración completo entregado y aprobado: reescritura en Next.js 14, aprovisionamiento del esquema de Supabase, pipeline de despliegue en Vercel.",
        },
        {
          phase: "Hora 24",
          label: "Migración en Curso",
          detail:
            "Base de código migrada a Next.js App Router. Base de datos de Supabase activa con políticas RLS aplicadas. Repositorio de GitHub inicializado con webhooks.",
        },
        {
          phase: "Hora 68",
          label: "En Producción",
          detail:
            "Aplicación desplegada en Vercel con dominio personalizado, todas las variables de entorno mapeadas y suite completa de pruebas funcionales aprobadas.",
        },
      ],
    },
  },
  ...
  form: {
    ...
    problem: {
      ...
      placeholder:
        "Describa el problema en detalle. ¿Qué intentaba hacer? ¿Qué mensajes de error está viendo?",
    ...
    success: {
      ...
      message:
        "Recibido. Revisaremos su solicitud y nos pondremos en contacto en pocas horas para confirmar el alcance y los próximos pasos.",
...
const pt: Translations = {
  ...
  howItWorks: {
    ...
    subheadline:
      "Três etapas estruturadas do protótipo de IA à infraestrutura de produção.",
    steps: [
      {
        number: "01",
  ...
  services: {
    ...
    subheadline:
      "O escopo exato é confirmado por escrito antes que qualquer pagamento seja solicitado.",
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          "Implementação de guardas de limite de taxa de API para prevenir picos de cobrança",
  ...
  caseStudy: {
    ...
    subheadline:
      "De protótipo de IA não implantado a stack de produção verificada em menos de 72 horas.",
    clientLabel: "Cliente A — Confidencial",
    ...
    stackTable: {
      ...
      rows: [
        ...
        ["Autenticação", "Sessão simulada quebrada", "Autenticação JWT do Supabase"],
      ...
      items: [
        {
          ...
          detail:
            "O cliente enviou um aplicativo gerado pelo Lovable — sem configuração de implantação, sem banco de dados, rotas de autenticação quebradas.",
        },
        {
          phase: "Hora 4",
          label: "Escopo Confirmado",
          detail:
            "Escopo completo de migração entregue e aprovado: reescrita no Next.js 14, provisionamento do esquema Supabase, pipeline de implantação no Vercel.",
        },
        {
          phase: "Hora 24",
          label: "Migração em Andamento",
          detail:
            "Base de código migrada para o Next.js App Router. Banco de dados Supabase ativo com políticas RLS aplicadas. Repositório GitHub inicializado com webhooks.",
        },
        {
          phase: "Hora 68",
          label: "Em Produção",
          detail:
            "Aplicativo implantado no Vercel com domínio personalizado, todas as variáveis de ambiente mapeadas e suite completa de testes funcionais aprovados.",
        },
      ],
    },
  },
  ...
  form: {
    ...
    problem: {
      ...
      placeholder:
        "Descreva o problema em detalhes. O que você tentou fazer? Quais mensagens de erro está vendo?",
    ...
    success: {
      ...
      message:
        "Recebemos. Revisaremos sua solicitação e entraremos em contato em poucas horas para confirmar o escopo e os próximos passos.",
