import type { HowItWorksT } from "@/lib/i18n";

interface Props { t: HowItWorksT }
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
          ...
          {t.steps.map((step, i) => (
            <div
              key={step.number}
              className="relative bg-white rounded-xl border border-slate-200/80 p-8 shadow-sm hover:shadow-md hover:border-slate-300 transition-all duration-200"
            >
