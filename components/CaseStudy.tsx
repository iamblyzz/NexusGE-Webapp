    ...
    <section id="case-study" className="py-24 bg-slate-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white shadow-sm overflow-hidden">
          ...
          {/* Panel header */}
          <div className="px-6 sm:px-8 py-5 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-slate-50/70">
            <div>
              ...
              <div className="flex flex-col gap-7">
                {t.timeline.items.map((item, i) => (
                  <div key={i} className="flex gap-5 items-start">
                    {/* Node */}
                    <div className="relative flex-shrink-0 w-9 h-9 rounded-full bg-white border-2 border-blue-200 flex items-center justify-center z-10 shadow-sm">
